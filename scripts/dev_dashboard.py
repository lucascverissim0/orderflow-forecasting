"""
Dev dashboard for orderflow-forecasting.

Run with:
    python -m uvicorn scripts.dev_dashboard:app --host 0.0.0.0 --port 8000 --reload
Then open the port-8000 URL in your browser.
"""
...
app = FastAPI(title="orderflow-forecasting DEV dashboard", version="0.0.1")

# Broad CORS is fine here; everything is same-origin in practice.
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
<body>
  ...
  <p>Minimal dashboard served directly by FastAPI (dev_dashboard).</p>
